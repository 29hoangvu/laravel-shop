@extends('admindashboard.component.layout')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center ">
                    ...
                    <a href="{{ route('admindashboard.products.index') }}" class="btn btn-secondary bg-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admindashboard.products.store') }}" method="POST" enctype="multipart/form-data" id="createProductForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admindashboard.products.index') }}" class="btn btn-secondary me-2">
