...
@section('content')
    ...
    <a href="{{ route('admindashboard.products.create') }}" class="btn btn-primary mb-3">
                ...
                <tbody>
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admindashboard.products.edit', $product->product_id) }}"
    ...
    <script>
        ...
        function deleteProduct(id) {
            if (confirm('Bạn có chắc chắn muốn xóa sản phẩm này?')) {
                $.ajax({
                    url: '{{ route('admindashboard.products.destroy', ':id') }}'.replace(':id', id),
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
