        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admindashboard.category.index') }}" class="btn btn-secondary bg-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admindashboard.category.store') }}" method="POST" id="createCategoryForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
