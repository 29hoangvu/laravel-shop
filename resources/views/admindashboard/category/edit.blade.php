        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admindashboard.category.index') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admindashboard.category.update', $category->category_id) }}" method="POST" id="editCategoryForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admindashboard.category.index') }}" class="btn btn-secondary me-2">
